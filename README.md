...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/abhishek-musmade-0582a7289/)
...
|------------|---------------|---------------|
| **FixIT** | A web application for college hardware and software complaints management team, which simplifies complaint submission, status
tracking, complaint history, complaint transfer and resolution details, all under the admin’s supervision. | [Live Demo](https://hardware-management-frontend.vercel.app/user/login) |
