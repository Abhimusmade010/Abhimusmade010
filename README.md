...
|------------|---------------|---------------|
| **FixIT** | A web application for college hardware and software complaints management team, which simplifies complaint submission, status tracking. | [Live Demo](https://hardware-management-frontend.vercel.app/user/login) |
